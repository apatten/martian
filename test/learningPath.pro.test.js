 ...
 */
 ...
 describe('Learning Pro Path API', () => {
     let lpm = null;
     beforeEach(() => {
         lpm = new LearningPathProManager();
     });
     afterEach(() => {
         lpm = null;
     });
     describe('constructor', () => {
         it('can construct a new Learning Path', () => {
             let learningPath = new LearningPathPro('foobar');
             expect(learningPath).toBeDefined();
             expect(() => learningPathPro()).toThrow();
             expect(() => LearningPathProManager()).toThrow();
         });
     });
     ...
     describe('learning path operations', () => {
         ...
         beforeEach(() => {
             learningPath = new LearningPathPro('foobar');
         });
         afterEach(() => {
             learningPath = null;
         });
