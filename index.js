...
System.register("npm:babel-runtime@5.8.25/core-js/object/keys", ["npm:core-js@0.9.18/library/fn/object/keys"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = {
...
System.register("errors/mtError", ["npm:babel-runtime@5.8.25/helpers/inherits", "npm:babel-runtime@5.8.25/helpers/class-call-check"], function (_export) {
    var _inherits, _classCallCheck, MTError;

    return {
        setters: [function (_npmBabelRuntime5825HelpersInherits) {
...
System.register('models/pageRatings.model', ['models/modelHelper', 'models/page.model'], function (_export) {
    /**
     * MindTouch Core JS API
     * Copyright (C) 2006-2015 MindTouch, Inc.
     * www.mindtouch.com  oss@mindtouch.com
        ...
        execute: function () {
            pageRatingsModel = {
                parse: function parse(data) {
                    ...
                    if ('page' in obj) {
                        parsed.page = [];
                        var pageArray = Array.isArray(obj.page) ? obj.page : [obj.page];
            ...
            _export('default', pageRatingsModel);
        }
    };
});
...
System.register('lib/utility', ['npm:babel-runtime@5.8.25/core-js/object/keys', 'lib/stringUtility'], function (_export) {
    var _Object$keys, stringUtility, utility;

    return {
        setters: [function (_npmBabelRuntime5825CoreJsObjectKeys) {
...
System.register('page.pro', ['npm:babel-runtime@5.8.25/helpers/inherits', 'npm:babel-runtime@5.8.25/helpers/class-call-check', 'npm:babel-runtime@5.8.25/core-js/promise', 'page', 'models/pageMove.model'], function (_export) {
...
System.register('feedback', ['lib/plug', 'lib/utility', 'lib/stringUtility', 'models/pageRatings.model'], function (_export) {
    ...
    return {
        setters: [function (_libPlug) {
            ...
            stringUtility = _libStringUtility['default'];
        }, function (_modelsPageRatingsModel) {
            pageRatingsModel = _modelsPageRatingsModel['default'];
        }],
        execute: function () {
            feedback = {
                submit: function submit(options) {
                    ...
                    var plug = new Plug().at('@api', 'deki', 'workflow', 'submit-feedback');
                    return plug.post(request, utility.jsonRequestType);
                },
                getRatingsForPages: function getRatingsForPages(pageIds) {
...
System.register('lib/uriHash', ['npm:babel-runtime@5.8.25/helpers/class-call-check', 'lib/utility', 'lib/stringUtility'], function (_export) {
...
System.register('errors/xhrError', ['npm:babel-runtime@5.8.25/helpers/inherits', 'npm:babel-runtime@5.8.25/helpers/class-call-check', 'errors/mtError'], function (_export) {
...
System.register('lib/uri', ['npm:babel-runtime@5.8.25/helpers/class-call-check', 'npm:babel-runtime@5.8.25/core-js/object/keys', 'github:jspm/nodelibs-url@0.1.0', 'lib/uriHash', 'lib/stringUtility'], function (_export) {
